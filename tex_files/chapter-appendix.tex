...
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{hyper_comp_germany_1.png}
...
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{hyper_comp_germany_1.svg}
%     \caption{Value of the precision and $\phi$ when changing the value for $\sigma_0$. The black line highlights the values for $\sigma_0$ = 1.}
%     \label{comparison_germany_3}
% \end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{hyper_comp_germany_2.png}
    \caption{Value of the precision and $\phi$ when changing the value for $\sigma_0$. The black line highlights the values for $\sigma_0$ = 1.}
    \label{comparison_germany_4}
\end{figure}
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{hyper_comp_germany_2.svg}
%     \caption{Value of the precision and $\phi$ when changing the value for $\sigma_0$. The black line highlights the values for $\sigma_0$ = 1.}
%     \label{comparison_germany_4}
% \end{figure}
\begin{figure}[H]

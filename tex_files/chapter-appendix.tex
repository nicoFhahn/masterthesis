...
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{waic_germany_smooth.png}
    \caption{Value the WAIC when changing the value for $\sigma_0$. The black line highlights the values for $\sigma_0$ = 1.}
    \label{comparison_germany_1}
\end{figure}
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{waic_germany_smooth.svg}
%     \caption{Value of the WAIC when changing the value for $\sigma_0$. The black line highlights the values for $\sigma_0$ = 1.}
%     \label{comparison_germany_1}
% \end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{mae_germany_smooth.png}
    \caption{Value the MAE when changing the value for $\sigma_0$. The black line highlights the values for $\sigma_0$ = 1.}
    \label{comparison_germany_2}
\end{figure}
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{mae_germany_smooth.svg}
...
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{intervals_prior_germany.svg}
%    \caption{Comparison of the credibility intervals of a BYM2 model for different values of $\sigma_0$}
%     \label{comparison_germany_5}
% \end{figure}
\begin{figure}[H]
...
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{spatial_field_germany_1.svg}
%    \caption{Spatial field for a Besag model and a Leroux model.}
%     \label{comparison_germany_6}
% \end{figure}
\begin{figure}[H]
...
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{spatial_field_germany_2.svg}
%    \caption{Spatial fields for a BYM2 model.}
%     \label{comparison_germany_7}
% \end{figure}
\begin{figure}[H]
...
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{spatial_field_germany_3.svg}
%    \caption{Spatial fields for the structured component of a BYM2 model when changing the value for $\sigma_0$.}
%     \label{comparison_germany_8}
% \end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width = \textwidth]{spatial_field_germany_4.png}
    \caption{Structured component of the spatial field for a BYM2 model.}
    \label{comparison_germany_9}
\end{figure}
% \begin{figure}[H]
%     \centering
%     \includesvg[width = \textwidth]{spatial_field_germany_4.svg}
%    \caption{Structured component of the spatial field for a BYM2 model.}
%     \label{comparison_germany_9}
% \end{figure}

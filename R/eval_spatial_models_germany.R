...
marginal_frame <- tibble(
  lower = c(
    ...
    inla.qmarginal(
      c(0.025, 0.975),
      inla.tmarginal(
        exp, models_final[[1]][[1]]$marginals.fixed$Union
      )
    )[1],
    inla.qmarginal(
      c(0.025, 0.975),
      inla.tmarginal(
        exp, models_final[[1]][[3]]$marginals.fixed$Union
      )
    )[1],
    inla.qmarginal(
      c(0.025, 0.975),
      inla.tmarginal(
        exp, models_final[[1]][[1]]$marginals.fixed$trade_tax
      )
    )[1],
    inla.qmarginal(
      c(0.025, 0.975),
      inla.tmarginal(
        exp, models_final[[1]][[3]]$marginals.fixed$trade_tax
      )
    )[1],
    inla.qmarginal(
      c(0.025, 0.975),
    ...
    inla.qmarginal(
      c(0.025, 0.975),
      inla.tmarginal(
        exp, models_final[[1]][[1]]$marginals.fixed$afd
      )
    )[1],
    inla.qmarginal(
      c(0.025, 0.975),
      inla.tmarginal(
        exp, models_final[[1]][[3]]$marginals.fixed$afd
      )
    )[1]
  ),
  mean = c(
    ...
    inla.emarginal(
      exp,
      models_final[[1]][[1]]$marginals.fixed$Union
    ),
    inla.emarginal(
      exp,
      models_final[[1]][[3]]$marginals.fixed$Union
    ),
    inla.emarginal(
      exp,
      models_final[[1]][[1]]$marginals.fixed$trade_tax
    ),
    inla.emarginal(
      exp,
      models_final[[1]][[3]]$marginals.fixed$trade_tax
    ),
    inla.emarginal(
      exp,
    ...
    inla.emarginal(
      exp,
      models_final[[1]][[1]]$marginals.fixed$afd
    ),
    inla.emarginal(
      exp,
      models_final[[1]][[3]]$marginals.fixed$afd
    )
  ),
  upper = c(
    inla.qmarginal(
...
zeta_cutoff <- c(0.1, 0.5, 0.9, 1, 1.4, 1.8, 2.2)
# group it
cat_zeta <- cut(
  unlist(zeta),
  breaks = zeta_cutoff,

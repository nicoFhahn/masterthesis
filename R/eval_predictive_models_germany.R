...
pdp_rf_3 <- FeatureEffect$new(predictor_rf, feature = "marketplace", method = "pdp")
pdp_rf_4 <- FeatureEffect$new(predictor_rf, feature = "platform", method = "pdp")
...
ice_rf_3 <- FeatureEffect$new(predictor_rf, feature = "marketplace", method = "ice")
ice_rf_4 <- FeatureEffect$new(predictor_rf, feature = "platform", method = "ice")
...
pdp_xgboost_2 <- FeatureEffect$new(predictor_xgboost, feature = "afd", method = "pdp")
ice_xgboost_1 <- FeatureEffect$new(predictor_xgboost, feature = "trade_tax", method = "ice")
ice_xgboost_2 <- FeatureEffect$new(predictor_xgboost, feature = "afd", method = "ice")
...
pdp_nnet_1 <- FeatureEffect$new(predictor_nnet, feature = "trade_tax", method = "pdp")
pdp_nnet_2 <- FeatureEffect$new(predictor_nnet, feature = "marketplace", method = "pdp")
ice_nnet_1 <- FeatureEffect$new(predictor_nnet, feature = "trade_tax", method = "ice")
ice_nnet_2 <- FeatureEffect$new(predictor_nnet, feature = "marketplace", method = "ice")
...
pdp_rpart_2 <- FeatureEffect$new(predictor_rpart, feature = "afd", method = "pdp")
ice_rpart_1 <- FeatureEffect$new(predictor_rpart, feature = "trade_tax", method = "ice")
ice_rpart_2 <- FeatureEffect$new(predictor_rpart, feature = "afd", method = "ice")
...
shapley_rf_hannover <- Shapley$new(predictor_rf, x.interest = newest_numbers_test[77, c(1, 3:13, 15:20)])
...
shapley_1_rf <- shapley_rf_hannover$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_rf_hannover$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_test$municipality[77], "(Test)")
  )
shapley_rf_munich <- Shapley$new(predictor_rf, x.interest = newest_numbers_train[178, c(1, 3:13, 15:20)])
...
shapley_2_rf <- shapley_rf_munich$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_rf_munich$y.hat.average, 2), sep = ""
    ),
...
shapley_fnn_hannover <- Shapley$new(predictor_fnn, x.interest = newest_numbers_test[77, c(1, 3:13, 15:20)])
...
shapley_1_fnn <- shapley_fnn_hannover$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_fnn_hannover$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_test$municipality[77], "(Test)")
  )
shapley_fnn_munich <- Shapley$new(predictor_fnn, x.interest = newest_numbers_train[178, c(1, 3:13, 15:20)])
...
shapley_2_fnn <- shapley_fnn_munich$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_fnn_munich$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_train$municipality[178], "(Train)")
  )
shapley_2_fnn +
...
shapley_xgboost_hannover <- Shapley$new(predictor_xgboost, x.interest = newest_numbers_test[77, c(1, 3:13, 15:20)])
...
shapley_1_xgboost <- shapley_xgboost_hannover$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_xgboost_hannover$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_test$municipality[77], "(Test)")
  )
shapley_xgboost_munich <- Shapley$new(predictor_xgboost, x.interest = newest_numbers_train[178, c(1, 3:13, 15:20)])
...
shapley_2_xgboost <- shapley_xgboost_munich$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_xgboost_munich$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_train$municipality[178], "(Train)")
  )
shapley_2_xgboost +
...
shapley_nnet_hannover <- Shapley$new(predictor_nnet, x.interest = newest_numbers_test[77, c(1, 3:13, 15:20)])
...
shapley_1_nnet <- shapley_nnet_hannover$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_nnet_hannover$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_test$municipality[77], "(Test)")
  )
shapley_nnet_munich <- Shapley$new(predictor_nnet, x.interest = newest_numbers_train[178, c(1, 3:13, 15:20)])
...
shapley_2_nnet <- shapley_nnet_munich$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_nnet_munich$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_train$municipality[178], "(Train)")
  )
shapley_2_nnet +
...
shapley_rpart_hannover <- Shapley$new(predictor_rpart, x.interest = newest_numbers_test[77, c(1, 3:13, 15:20)])
...
shapley_1_rpart <- shapley_rpart_hannover$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_rpart_hannover$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_test$municipality[77], "(Test)")
  )
shapley_rpart_munich <- Shapley$new(predictor_rpart, x.interest = newest_numbers_train[178, c(1, 3:13, 15:20)])
...
shapley_2_rpart <- shapley_rpart_munich$plot() +
  ...
  ggtitle(
    paste(
      ...
      "\nAverage prediction: ", round(shapley_rpart_munich$y.hat.average, 2), sep = ""
    ),
    subtitle = paste("Municipality:", newest_numbers_train$municipality[178], "(Train)")
  )
shapley_2_rpart +

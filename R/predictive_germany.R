# this is the script for computing the predictive models for germany
library(mlr)
library(tibble)
...
predictions_test <- lapply(
  models,
  predict,
  newdata = newest_numbers_test[, c(1:12, 14:19)]
)
...
save(model_list, file = "models/predictive_germany.Rda")

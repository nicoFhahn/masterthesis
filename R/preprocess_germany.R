...
no_geometry[, 37:39] <- NULL
no_geometry[, 66:80] <- NULL
...
germany_features$empfaenger_asylbewerber_weiblich <- as.numeric(trimws(germany_features$empfaenger_asylbewerber_weiblich))
germany_features$empfaenger_asylbewerber_maennlich <- as.numeric(trimws(germany_features$empfaenger_asylbewerber_maennlich))
...
germany_features$sozialhilfeempfaenger_maennlich <- as.numeric(trimws(germany_features$sozialhilfeempfaenger_maennlich))
germany_features$sozialhilfe_ausser_einrichtung_ausland <- as.numeric(trimws(germany_features$sozialhilfe_ausser_einrichtung_ausland))
germany_features[, c(2:4, 9:28, 42:65)] <- 1000 * germany_features[, c(2:4, 9:28, 42:65)] / germany_features$PopulationTotal
